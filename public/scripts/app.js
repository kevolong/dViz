import { educationDataset, geometryDataset, choroplethHTML } from "./choropleth.js";
import { dopingDataset, scatterHTML } from "./scatterplot.js";
import { gamesDataset, moviesDataset, kickstarterDataset, treeHTML } from "./treemaps.js";
import { heatDataset, rectColors, heatHTML } from "./heatmap.js";
import { gdpDataset, chartHTML } from "./chart.js";
...
<<<<<<< HEAD
  $("main").html(choroplethHTML);
  // Copy json data and simplify for geo data
  const eduData = [...educationDataset];
  const geoData = Object.assign({}, geometryDataset);
=======
  $("main").load("https://github.com/kevolong/dViz/blob/master/public/html/choropleth.html #choropleth-container", function() {
    // Copy json data and simplify for geo data
    const eduData = [...educationDataset];
    const geoData = Object.assign({}, geometryDataset);
>>>>>>> a9c38b76d8b7f529cc0a30bd637c0163546a0cbf
